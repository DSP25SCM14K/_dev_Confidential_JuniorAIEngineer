...
const phrases = [
  "RAG pipelines with citations and reranking",
  "LangChain agents with safe tool use",
  "LLM evaluation harnesses and A/B tests",
  "streaming FastAPI services for GenAI apps",
